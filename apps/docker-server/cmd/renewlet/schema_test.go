...
func TestEnsureSchemaCreatesContractFieldsAndIndexes(t *testing.T) {
	...
	assertSelectFieldValues(t, app, "subscriptions", "billingCycle", "weekly", "monthly", "quarterly", "semi-annual", "annual", "custom", "one-time", "usage-based")
	...
	assertTextFieldRequired(t, app, "subscriptions", "usageUnit", false)
	assertNumberField(t, app, "subscriptions", "usageTotal", false, 0, 1000000000)
	assertNumberField(t, app, "subscriptions", "usageDailyRate", false, 0, 1000000000)
